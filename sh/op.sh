...
git_sparse_clone openwrt-24.10 https://github.com/openwrt/openwrt package/kernel/mt76
git_sparse_clone openwrt-24.10 https://github.com/openwrt/openwrt target/linux/generic
git_sparse_clone openwrt-24.10 https://github.com/openwrt/openwrt target/linux/mediatek
git_sparse_clone openwrt-24.10 https://github.com/openwrt/openwrt package/kernel/mac80211
git_sparse_clone openwrt-24.10 https://github.com/openwrt/openwrt package/network/config/wifi-scripts
git_sparse_clone openwrt-24.10 https://github.com/openwrt/openwrt package/firmware/wireless-regdb
...
cp -rf wireless-regdb package/firmware
cp -rf wifi-scripts package/network/config
cp -rf mt76 package/kernel
cp -rf generic target/linux
cp -rf mediatek target/linux
cp -rf mac80211 package/kernel

curl -s https://raw.githubusercontent.com/openwrt/openwrt/openwrt-24.10/include/kernel-6.6 > include/kernel-6.6
